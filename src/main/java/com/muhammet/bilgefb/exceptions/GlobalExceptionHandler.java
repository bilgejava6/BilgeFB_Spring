...
import static com.muhammet.bilgefb.exceptions.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BilgeFbException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> Java8StartExceptionHandler(BilgeFbException ex){
